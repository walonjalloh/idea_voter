  ...
  return (
    <section className=" flex flex-col justify-center items-center bg-hero-image bg-cover bg-no-repeat bg-center h-[600px]">
        <div className=" flex flex-col">
            ...
            <p className="font-bold text-md text-black md:text-4xl my-10 text-center">Discover the power of collective wisdom. Submit your ideas and let the community decide.</p>
        </div>
        <div>
